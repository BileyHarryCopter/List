...
{
    printf ("There are some errors in the program... Check the \"Logfile\" in the directory \"sources/logs/\"\n");
...
{
    FILE * logfile = fopen ("sources/logs/Logfile", "w");
    assert (logfile);
        ...
        default:
            {
                ...
                fprintf (logfile, "I am grateful and very please you write about the problem on my GitHub repo:\n");
